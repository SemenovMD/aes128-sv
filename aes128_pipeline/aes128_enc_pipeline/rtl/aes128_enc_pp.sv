...
(
    ...
    stage_enc_hand_s_axis stage_enc_hand_s_axis_inst
    (
        .aclk(aclk),
        .aresetn(aresetn),
    ...
    generate
        for (i = 1; i < 10; i++) begin : gen_round_stage_enc
            round_stage_enc round_stage_enc_inst
            (
                .aclk(aclk),
                .aresetn(aresetn),
                .en(s_axis_tready),
    ...
    round_stage_enc_final round_stage_enc_final_inst
    (
        .aclk(aclk),
        .aresetn(aresetn),
        .en(s_axis_tready),
    ...
    stage_enc_hand_m_axis stage_enc_hand_m_axis_inst
    (
        .aclk(aclk),
        .aresetn(aresetn),
